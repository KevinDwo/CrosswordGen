...
class CrosswordGridLayouts:
    ...
    def load_layout(number: int) -> CrosswordGridTemplate:
        ...
        if number == 2: 
            ...
            grid.set_placeholder(0, 4, 4, Direction.DOWNABOVE, 4)
            grid.set_placeholder(0, 5, 5, Direction.DOWNABOVE, 5)
            grid.set_placeholder(0, 7, 4, Direction.DOWNLEFT, 6)
            grid.set_placeholder(0, 9, 5, Direction.DOWNABOVE, 7)
            grid.set_placeholder(0, 11, 8, Direction.DOWNLEFT, 8)
            ...
            grid.set_placeholder(2, 0, 4, Direction.RIGHTABOVE, 12)
            grid.set_placeholder(2, 2, 5, Direction.RIGHTLEFT, 13)
            ...
            grid.set_placeholder(8, 0, 5, Direction.RIGHTLEFT, 29)
            grid.set_placeholder(8, 10, 3, Direction.DOWNABOVE, 30)
            grid.set_placeholder(8, 9, 3, Direction.DOWNABOVE, 31)
